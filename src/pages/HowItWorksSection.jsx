  ...
  const steps = [
    {
      ...
      // Custom SVG representation matching the top quirky creation art
      illustration:image1
    },
    {
      id: 2,
      ...
      // Custom SVG representation matching the stylized character hugging the lightning bolt
      illustration: image2
    },
    {
      id: 3,
      ...
      // Custom SVG representation matching the raised hand device/popper art
      illustration: image3
    ...
    <section className="bg-white py-20 px-6 md:px-12 lg:px-24 font-sans select-none overflow-hidden">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          {/* Flat blue custom underline bar */}
        ...
        <div className="space-y-24 md:space-y-16">
          {steps.map((step, index) => {
            // Alternating layouts: Even items switch image and text sides on desktop viewports
