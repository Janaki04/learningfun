...
export default function FeaturesSection() {
  ...
  return (
    <section className="bg-[#F3F4F6] py-20 px-6 sm:px-12 font-sans lg:px-24 text-center">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16 inline-block">
          ...
          <div className="h-1.5 w-16 bg-[#3A5AFF] mx-auto mt-2 rounded-full"></div>
        </div>
        ...
        <div className="pt-4">
          <button
            ...
            className="bg-[#3A5AFF] hover:bg-[#FFC43B] border-b-4  border-[#804000] border-800  text-white font-extrabold tracking-wide text-sm px-10 py-4 rounded-md shadow-lg shadow-blue-200 uppercase transition transform active:scale-98"
          >
            Sign up now
          </button>
        </div>
